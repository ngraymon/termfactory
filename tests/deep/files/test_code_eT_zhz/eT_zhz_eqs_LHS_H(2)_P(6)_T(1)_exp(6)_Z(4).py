    ...
    if ansatz.ground_state:
        ...
        if truncation.h_at_least_quadratic:
            if truncation.t_singles:
                ...
                if truncation.z_at_least_linear:
                    Z += (1 / 2) * np.einsum('i, j, k, jk, ci -> c', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(1, 0)])
                if truncation.z_at_least_quadratic:
                    Z += (1 / 4) * np.einsum('i, j, k, l, kl, cij -> c', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(2, 0)])
                if truncation.z_at_least_cubic:
                    Z += (1 / 12) * np.einsum('i, j, k, l, m, lm, cijk -> c', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                if truncation.z_at_least_quartic:
                    Z += (1 / 48) * np.einsum('i, j, k, l, m, n, mn, cijkl -> c', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
    else:
        raise NotImplementedError('Hot Band amplitudes not implemented!')
    ...
    if ansatz.ground_state:
        ...
        if truncation.h_at_least_quadratic:
            if truncation.t_singles:
                ...
                if truncation.z_at_least_quadratic:
                    Z += (1 / 2) * (
                        np.einsum('i, j, k, jk, ciz -> cz', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(2, 0)]) +
                        np.einsum('i, j, k, kz, cij -> cz', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(2, 0)])
                    )
                if truncation.z_at_least_cubic:
                    Z += (1 / 4) * np.einsum('i, j, k, l, kl, cijz -> cz', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                    Z += (1 / 6) * np.einsum('i, j, k, l, lz, cijk -> cz', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                if truncation.z_at_least_quartic:
    ...
    if ansatz.ground_state:
        ...
        if truncation.h_at_least_quadratic:
            if truncation.t_singles:
                ...
                if truncation.z_at_least_quadratic:
                    Z += np.einsum('i, j, jz, ciy -> czy', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(2, 0)])
                    Z += (1 / 4) * (
                        np.einsum('i, j, zy, cij -> czy', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(2, 0)]) +
                        np.einsum('i, j, ij, czy -> czy', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(2, 0)])
                    )
                if truncation.z_at_least_cubic:
                    Z += (1 / 12) * np.einsum('i, j, k, zy, cijk -> czy', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                    Z += (1 / 2) * np.einsum('i, j, k, kz, cijy -> czy', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                    Z += (1 / 4) * np.einsum('i, j, k, jk, cizy -> czy', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                if truncation.z_at_least_quartic:
                    Z += (1 / 48) * np.einsum('i, j, k, l, zy, cijkl -> czy', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
                    Z += (1 / 6) * np.einsum('i, j, k, l, lz, cijky -> czy', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
                    Z += (1 / 8) * np.einsum('i, j, k, l, kl, cijzy -> czy', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
    else:
        raise NotImplementedError('Hot Band amplitudes not implemented!')
    ...
    if ansatz.ground_state:
        ...
        if truncation.h_at_least_quadratic:
            if truncation.t_singles:
                ...
                if truncation.z_at_least_cubic:
                    Z += (1 / 12) * np.einsum('i, j, ij, czyx -> czyx', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                    Z += (1 / 2) * np.einsum('i, j, jz, ciyx -> czyx', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                    Z += (1 / 4) * np.einsum('i, j, zy, cijx -> czyx', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(3, 0)])
                if truncation.z_at_least_quartic:
                    Z += (1 / 12) * (
                        np.einsum('i, j, k, jk, cizyx -> czyx', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)]) +
                        np.einsum('i, j, k, zy, cijkx -> czyx', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
                    )
                    Z += (1 / 4) * np.einsum('i, j, k, kz, cijyx -> czyx', t_conj[(0, 1)], t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
    else:
        raise NotImplementedError('Hot Band amplitudes not implemented!')
    ...
    if ansatz.ground_state:
        ...
        if truncation.h_at_least_quadratic:
            if truncation.t_singles:
                ...
                if truncation.z_at_least_quartic:
                    Z += (1 / 48) * np.einsum('i, j, ij, czyxw -> czyxw', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
                    Z += (1 / 6) * np.einsum('i, j, jz, ciyxw -> czyxw', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
                    Z += (1 / 8) * np.einsum('i, j, zy, cijxw -> czyxw', t_conj[(0, 1)], t_conj[(0, 1)], dT[(2, 0)], z_args[(4, 0)])
    else:
        raise NotImplementedError('Hot Band amplitudes not implemented!')
