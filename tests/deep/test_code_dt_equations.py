...
class Test_generate_optimized_disconnected_einsum_function_call_list:
    ...
    def test_basic(self):
        partition = (1, 1)
        order = 2
        function_output = cdt._generate_optimized_disconnected_einsum_function_call_list(partition, order, iterator_name='optimized_einsum')
...
class Test_construct_linked_disconnected_definition:
    ...
    def test_basic(self):
        return_string = ''
        order = 2
        function_output = cdt._construct_linked_disconnected_definition(return_string, order, opt_einsum=False, iterator_name='optimized_einsum')
    ...
    def test_einsum(self):
        return_string = ''
        order = 2
        function_output = cdt._construct_linked_disconnected_definition(return_string, order, opt_einsum=True, iterator_name='optimized_einsum')
...
class Test_construct_un_linked_disconnected_definition:
    ...
    def test_basic(self):
        return_string = ''
        order = 2
        function_output = cdt._construct_un_linked_disconnected_definition(return_string, order, opt_einsum=False, iterator_name='optimized_einsum')
    ...
    def test_einsum(self):
        return_string = ''
        order = 2
        function_output = cdt._construct_un_linked_disconnected_definition(return_string, order, opt_einsum=True, iterator_name='optimized_einsum')
...
class Test_construct_dt_amplitude_definition:
    ...
    def test_basic(self):
        return_string = ''
        order = 2
        function_output = cdt._construct_dt_amplitude_definition(return_string, order, opt_einsum=False, iterator_name='optimized_einsum')
    ...
    def test_einsum(self):
        return_string = ''
        order = 3
        function_output = cdt._construct_dt_amplitude_definition(return_string, order, opt_einsum=True, iterator_name='optimized_einsum')
