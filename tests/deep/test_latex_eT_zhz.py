...
# import pytest
# local imports
from .context import latex_eT_zhz as et
...
class Test_z_joining_with_z_terms_eT:
    ...
    def test_basic(self):
        ...
        left_z = et.general_operator_namedtuple(name=None, rank=0, m=0, n=0)
...
class Test_t_joining_with_t_terms_eT:
    ...
    def test_false_case(self):
        omega = et.general_operator_namedtuple(name='', rank=0, m=0, n=0)
        t_list = [et.general_operator_namedtuple(name='1', rank=0, m=0, n=0)]
        h = fcc.h_operator_namedtuple(rank=0, m=0, n=0)
        z_left = et.general_operator_namedtuple(name=None, rank=0, m=0, n=0)
...
class Test_generate_valid_eT_z_n_operator_permutations:
    ...
    def test_basic(self):
        ...
        h = fcc.h_operator_namedtuple(rank=0, m=0, n=0)
        all_z_permutations = [(et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z', rank=0, m=0, n=0)), (et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0))]
        function_output = et._generate_valid_eT_z_n_operator_permutations(LHS, eT, h, all_z_permutations)
        expected_result = [((et.general_operator_namedtuple(name='1', rank=0, m=0, n=0),),  et.general_operator_namedtuple(name=None, rank=0, m=0, n=0),  et.general_operator_namedtuple(name='z', rank=0, m=0, n=0))]
        assert function_output == expected_result

    def test_perm_T_greater_than_one(self):
        """len(perm_T) != 1"""
        LHS = et.general_operator_namedtuple(name='', rank=0, m=0, n=0)
        eT = [[et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1), et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1)], [et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1), et.general_operator_namedtuple(name='s_2', rank=2, m=0, n=2)], [et.general_operator_namedtuple(name='s_2', rank=2, m=0, n=2), et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1)], [et.general_operator_namedtuple(name='s_2', rank=2, m=0, n=2), et.general_operator_namedtuple(name='s_2', rank=2, m=0, n=2)]]
        h = fcc.h_operator_namedtuple(rank=0, m=0, n=0)
        all_z_permutations = [(et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z', rank=0, m=0, n=0)), (et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0)), (et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^2', rank=2, m=2, n=0))]
        function_output = et._generate_valid_eT_z_n_operator_permutations(LHS, eT, h, all_z_permutations)
        expected_result = [((et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1), et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1)), et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^2', rank=2, m=2, n=0))]
        assert function_output == expected_result
...
class Test_generate_all_valid_eT_z_connection_permutations:
    ...
    def test_basic(self):
        ...
        left_z = et.general_operator_namedtuple(name=None, rank=0, m=0, n=0)
        right_z = et.general_operator_namedtuple(name='z', rank=0, m=0, n=0)
        function_output = et._generate_all_valid_eT_z_connection_permutations(LHS, t_list, h, left_z, right_z, log_invalid=True)
...
class Test_generate_all_valid_eT_connection_permutations:
    ...
    def test_basic(self):
        ...
        t_list = (et.general_operator_namedtuple(name='1', rank=0, m=0, n=0),)
        h = fcc.h_operator_namedtuple(rank=0, m=0, n=0)
        z_pair = (None, et.disconnected_eT_z_right_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=0, n_h=0, m_l=0, n_l=0))
    ...
    def test_z_right_is_none(self):
        ...
        t_list = (et.general_operator_namedtuple(name='1', rank=0, m=0, n=0),)
        h = fcc.h_operator_namedtuple(rank=0, m=0, n=0)
        z_pair = (et.disconnected_eT_z_left_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_h=0, n_h=0, m_r=0, n_r=0, m_t=(0,), n_t=(0,)), None)
        function_output = et._generate_all_valid_eT_connection_permutations(LHS, t_list, h, z_pair, log_invalid=True)
        expected_result = ([[[0, 0, 0, 0]]], [[[0, 0, 0, 0]]])
        assert function_output == expected_result
...
class Test_generate_all_o_eT_h_z_connection_permutations:
    ...
    def test_basic(self):
        LHS = et.general_operator_namedtuple(name='', rank=0, m=0, n=0)
        h = fcc.h_operator_namedtuple(rank=0, m=0, n=0)
        valid_permutations = [((et.general_operator_namedtuple(name='1', rank=0, m=0, n=0),), et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z', rank=0, m=0, n=0))]
        function_output = et._generate_all_o_eT_h_z_connection_permutations(LHS, h, valid_permutations, found_it_bool=False)
        expected_result = [((et.disconnected_t_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=0),), (None, et.disconnected_eT_z_right_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=0, n_h=0, m_l=0, n_l=0)))]
        assert function_output == expected_result
    ...
    def test_connected_z(self):
        ...
        valid_permutations = [((et.general_operator_namedtuple(name='1', rank=0, m=0, n=0),), et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0))]
        function_output = et._generate_all_o_eT_h_z_connection_permutations(LHS, h, valid_permutations, found_it_bool=False)
        expected_result = [((et.disconnected_t_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=0),), (None, et.connected_eT_z_right_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=1, n_h=0, m_l=0, n_l=0)))]
        assert function_output == expected_result
    ...
    def test_t_list_long(self):
        ...
        h = fcc.h_operator_namedtuple(rank=1, m=1, n=0)
        valid_permutations = [((et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1),), et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0))]
        function_output = et._generate_all_o_eT_h_z_connection_permutations(LHS, h, valid_permutations, found_it_bool=False)
        expected_result = [
            (
...
class Test_generate_explicit_eT_z_connections:
    ...
    def test_basic(self):
        ...
        function_output = et._generate_explicit_eT_z_connections(LHS, h, unique_permutations)
        expected_result = [
            [
                et.connected_eT_lhs_operator_namedtuple(rank=0, m=0, n=0, m_l=0, n_l=0, m_t=[0], n_t=[0], m_h=0, n_h=0, m_r=0, n_r=0),
                (et.disconnected_t_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=0),),
    ...
    def test_unequal_kwargs_case_2(self):
        ...
        unique_permutations = [
            ...
            ((et.connected_t_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=1, m_r=0, n_r=0),),
                (None, et.connected_eT_z_right_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=1, n_h=0, m_l=0, n_l=0))),
            ((et.connected_t_operator_namedtuple(rank=2, m=0, n=2, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=1, m_r=0, n_r=1),),
                (None, et.disconnected_eT_z_right_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=(1,), n_t=(0,), m_h=0, n_h=0, m_l=0, n_l=0))),
            ((et.connected_t_operator_namedtuple(rank=2, m=0, n=2, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=1, m_r=0, n_r=1),),
                (None, et.connected_eT_z_right_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=1, n_h=0, m_l=0, n_l=0))),
            ((et.disconnected_t_operator_namedtuple(rank=2, m=0, n=2, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=2),),
                (None, et.disconnected_eT_z_right_operator_namedtuple(rank=2, m=2, n=0, m_lhs=0, n_lhs=0, m_t=(2,), n_t=(0,), m_h=0, n_h=0, m_l=0, n_l=0))),
            ((et.connected_t_operator_namedtuple(rank=2, m=0, n=2, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=1, m_r=0, n_r=1),),
...
class Test_build_eT_z_latex_prefactor:

    def test_basic(self):
        t_list = (et.disconnected_t_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=0),)
        h = et.connected_eT_h_z_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_t=[0], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=0)
        z_left = None
        z_right = et.disconnected_eT_z_right_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=0, n_h=0, m_l=0, n_l=0)
        function_output = et._build_eT_z_latex_prefactor(t_list, h, z_left, z_right, simplify_flag=True)
        expected_result = ''
        assert function_output == expected_result

    def test_f_factor(self):
        t_list = (et.disconnected_t_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=1), et.disconnected_t_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=1))
        h = et.connected_eT_h_z_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_t=[0, 0], n_t=[0, 0], m_l=0, n_l=0, m_r=0, n_r=0)
        z_left = None
    ...
    def test_n_factor(self):
        t_list = (et.disconnected_t_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=0),)
        h = et.connected_eT_h_z_operator_namedtuple(rank=2, m=0, n=2, m_lhs=0, n_lhs=0, m_t=[0], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=2)
        z_left = None
    ...
    def test_choose_result(self):
        """if choose_result > 1:"""
        t_list = (et.connected_t_operator_namedtuple(rank=2, m=0, n=2, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=1, m_r=0, n_r=1),)
        h = et.connected_eT_h_z_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=[1], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=0)
        z_left = None
...
class Test_f_t_h_contributions:
    ...
    def test_else_case(self):
        t_list = (et.connected_t_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=1, m_r=0, n_r=0),)
        h = et.connected_eT_h_z_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=[1], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=0)
        function_output = et._f_t_h_contributions(t_list, h)
        expected_result = [0]
        assert function_output == expected_result
...
class Test_build_eT_term_latex_labels:
    ...
    def test_rank_zero(self):
        t_list = (et.disconnected_t_operator_namedtuple(rank=0, m=0, n=0, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=0),)
        offset_dict = {'lower_h': '', 'upper_h': '', 'lower_left_z': '', 'upper_left_z': '', 'lower_right_z': '', 'upper_right_z': '', 'unlinked_index': 0, 'summation_index': 0}
    ...
    def test_rank_non_zero_with_sup(self):
        t_list = (et.disconnected_t_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_l=0, n_l=0, m_h=0, n_h=0, m_r=0, n_r=1),)  # maybe bad term
        offset_dict = {'lower_h': '', 'upper_h': '', 'lower_left_z': '', 'upper_left_z': '', 'lower_right_z': '', 'upper_right_z': '', 'unlinked_index': 0, 'summation_index': 0}
        function_output = et._build_eT_term_latex_labels(t_list, offset_dict, color=True, letters=True)
...
class Test_build_eT_hz_term_latex_labels:
    ...
    def test_rank_non_zero_with_sub(self):
        h = et.connected_eT_h_z_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_t=[0], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=1)
        offset_dict = {'lower_h': '', 'upper_h': '', 'lower_left_z': '', 'upper_left_z': '', 'lower_right_z': '', 'upper_right_z': '', 'unlinked_index': 0, 'summation_index': 0}
        function_output = et._build_eT_hz_term_latex_labels(h, offset_dict, color=True, letters=True)
    ...
    def test_rank_non_zero_with_sup(self):
        h = et.connected_eT_h_z_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=[1], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=0)
        offset_dict = {'lower_h': '', 'upper_h': '\\blue{k}', 'lower_left_z': '', 'upper_left_z': '\\magenta{}', 'lower_right_z': '', 'upper_right_z': '\\magenta{}', 'unlinked_index': 0, 'summation_index': 1}
        function_output = et._build_eT_hz_term_latex_labels(h, offset_dict, color=True, letters=True)
...
class Test_build_eT_right_z_term:
    ...
    def test_rank_non_zero_with_sub(self):
        h = et.connected_eT_h_z_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_t=[0], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=1)
        z_right = et.connected_eT_z_right_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=1, n_h=0, m_l=0, n_l=0)  # maybe bad z
        offset_dict = {'lower_h': '', 'upper_h': '', 'lower_left_z': '', 'upper_left_z': '', 'lower_right_z': '', 'upper_right_z': '\\blue{k}', 'unlinked_index': 0, 'summation_index': 1}
        function_output = et._build_eT_right_z_term(h, z_right, offset_dict, color=True, letters=True)
    ...
    def test_rank_non_zero_with_sup(self):
        h = et.connected_eT_h_z_operator_namedtuple(rank=1, m=0, n=1, m_lhs=0, n_lhs=0, m_t=[0], n_t=[0], m_l=0, n_l=0, m_r=0, n_r=1)
        z_right = et.connected_eT_z_right_operator_namedtuple(rank=1, m=1, n=0, m_lhs=0, n_lhs=0, m_t=(0,), n_t=(0,), m_h=1, n_h=0, m_l=0, n_l=0)
        offset_dict = {'lower_h': '', 'upper_h': '', 'lower_left_z': '', 'upper_left_z': '', 'lower_right_z': '', 'upper_right_z': '\\blue{k}', 'unlinked_index': 0, 'summation_index': 1}
        function_output = et._build_eT_right_z_term(h, z_right, offset_dict, color=True, letters=True)
...
class Test_prepare_third_eTz_latex:
    ...
    def test_basic(self):
        function_output = et._prepare_third_eTz_latex(Test_prepare_third_eTz_latex.term_list, split_width=5, remove_f_terms=False, print_prefactors=True, suppress_duplicates=True)
        expected_result = '(\\mathds1\\bh_0\\bz_0 + \\bar{f}\\mathds1\\bh^{}_{\\blue{k}\\red{}}\\bz^{\\blue{k}\\red{}}_{} + \\bar{f}\\bt^{}_{\\magenta{}\\blue{}\\magenta{k}\\red{}}\\bh_0\\bz^{\\magenta{k}\\red{}}_{} + \\bar{f}\\bt^{}_{\\magenta{}\\blue{k}\\magenta{}\\red{}}\\bh^{\\blue{k}\\blue{}\\red{}}_{}\\bz_0)'
        assert function_output == expected_result

    def test_f_terms_and_dupes(self):
        function_output = et._prepare_third_eTz_latex(Test_prepare_third_eTz_latex.term_list, split_width=5, remove_f_terms=True, print_prefactors=True, suppress_duplicates=False)
        expected_result = '(\\mathds1\\bh_0\\bz_0 + \\bar{f}\\mathds1\\bh^{}_{\\blue{k}\\red{}}\\bz^{\\blue{k}\\red{}}_{} + \\bar{f}\\bt^{}_{\\magenta{}\\blue{}\\magenta{k}\\red{}}\\bh_0\\bz^{\\magenta{k}\\red{}}_{} + \\bar{f}\\bt^{}_{\\magenta{}\\blue{k}\\magenta{}\\red{}}\\bh^{\\blue{k}\\blue{}\\red{}}_{}\\bz_0)'
        assert function_output == expected_result
...
class Test_prepare_eTz_z_terms:
    ...
    def test_basic(self):
        Z_left = None
        Z_right = zhz.z_operator_namedtuple(maximum_rank=1, operator_list=[et.general_operator_namedtuple(name='z', rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0)])
        function_output = et._prepare_eTz_z_terms(Z_left, Z_right, zhz_debug=False)
        expected_result = [(et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z', rank=0, m=0, n=0)), (et.general_operator_namedtuple(name=None, rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0))]
        assert function_output == expected_result
...
class Test_filter_out_valid_eTz_terms:
    ...
    def test_basic(self):
        LHS = et.general_operator_namedtuple(name='', rank=0, m=0, n=0)
        eT = et.general_operator_namedtuple(name='1', rank=0, m=0, n=0)
        H = et.hamiltonian_namedtuple(maximum_rank=1, operator_list=[fcc.h_operator_namedtuple(rank=0, m=0, n=0), fcc.h_operator_namedtuple(rank=1, m=0, n=1), fcc.h_operator_namedtuple(rank=1, m=1, n=0)])
        Z_left = None
        Z_right = zhz.z_operator_namedtuple(maximum_rank=1, operator_list=[et.general_operator_namedtuple(name='z', rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0)])
        total_list = []
...
class Test_build_third_eTz_term:
    ...
    def test_basic(self):
        LHS = et.general_operator_namedtuple(name='b', rank=1, m=0, n=1)
        eT_taylor_expansion = [et.general_operator_namedtuple(name='1', rank=0, m=0, n=0), [et.general_operator_namedtuple(name='s_1', rank=1, m=0, n=1)]]
        H = nt.hamiltonian_namedtuple(maximum_rank=1, operator_list=[fcc.h_operator_namedtuple(rank=0, m=0, n=0), fcc.h_operator_namedtuple(rank=1, m=0, n=1), fcc.h_operator_namedtuple(rank=1, m=1, n=0)])
        Z = zhz.z_operator_namedtuple(maximum_rank=1, operator_list=[et.general_operator_namedtuple(name='z', rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0)])
        function_output = et._build_third_eTz_term(LHS, eT_taylor_expansion, H, Z, remove_f_terms=False)
        expected_result = '(\\mathds1\\bh_0\\bz^{\\red{y}}_{} + \\mathds1\\bh^{\\blue{}\\red{y}}_{}\\bz_0 + \\bar{f}\\bt^{}_{\\magenta{}\\blue{}\\magenta{k}\\red{}}\\bh^{\\blue{}\\blue{}\\red{y}}_{}\\bz^{\\magenta{k}\\red{}}_{} + \\bar{f}\\bt^{}_{\\magenta{}\\blue{k}\\magenta{}\\red{}}\\bh^{\\blue{k}\\blue{}\\red{}}_{}\\bz^{\\magenta{}\\red{y}}_{})'
        assert function_output == expected_result
...
class Test_generate_eT_z_symmetric_latex_equations:
    ...
    def test_basic(self):
        ...
        H = nt.hamiltonian_namedtuple(maximum_rank=1, operator_list=[fcc.h_operator_namedtuple(rank=0, m=0, n=0), fcc.h_operator_namedtuple(rank=1, m=0, n=1), fcc.h_operator_namedtuple(rank=1, m=1, n=0)])
        Z = zhz.z_operator_namedtuple(maximum_rank=1, operator_list=[et.general_operator_namedtuple(name='z', rank=0, m=0, n=0), et.general_operator_namedtuple(name='z^1', rank=1, m=1, n=0)])
        function_output = et._generate_eT_z_symmetric_latex_equations(LHS, eT_taylor_expansion, H, Z, only_ground_state=True, remove_f_terms=False)
        expected_result = '\\bh^{i}(1-\\delta_{x\\gamma})\\\\&+\\sum\\Big((\\mathds1\\bh_0\\bz^{\\red{y}} + \\mathds1\\bh^{\\blue{}\\red{y}}\\bz_0 + \\bar{f}\\bt_{\\magenta{}\\blue{}\\magenta{k}\\red{}}\\bh^{\\blue{}\\blue{}\\red{y}}\\bz^{\\magenta{k}\\red{}} + \\bar{f}\\bt_{\\magenta{}\\blue{k}\\magenta{}\\red{}}\\bh^{\\blue{k}\\blue{}\\red{}}\\bz^{\\magenta{}\\red{y}})\\Big)(1-\\delta_{cb})\\\\&-i\\sum\\Big(\\dv{\\hat{\\bt}^{i}_{\\gamma}}{\\tau}\\,\\hat{\\bz}_{0, \\gamma} + \\dv{\\hat{\\bt}_{0, \\gamma}}{\\tau}\\,\\hat{\\bz}^{i}_{\\gamma}\\Big)'
        assert function_output == expected_result
...
class Test_run_main_et_zhz:
    ...
    def test_run_main(self):
        et.generate_eT_z_t_symmetric_latex([1, 1, 1, 1, 1], only_ground_state=True, remove_f_terms=False, path="./generated_latex.tex")
